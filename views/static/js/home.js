$( document ).ready(function() {
    ...
    $(document).on("click", ".btn-edt-record", function(event) { 
        ...
        .done((data) => {
            if(data) {
                ...
                $('#inputName').val(odata.name);
                $('#inputAddress').val(odata.address);
                $('#inputSalary').val(odata.salary);
                $('#id').val(odata._id);
                $('#btnSubmit').hide();
                $('#btnUpdate').show();
                $("form#addUserForm").prop('id','editUserForm');
    ...
    //-------------------------------------------------------END
     ...
     //on update submit the form----------------------------START
     $("#btnUpdate").click (() => {
        $("#editUserForm").submit();
    });
...
function getEdtBtn(val) {
    return '<td><button type="button" id='+ val +' class="btn btn-default btn-sm btn-edt-record"><span class="fa fa-edit"></span> Edit </button></td>';
}